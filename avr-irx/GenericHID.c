...
{
	printf("EVENT_USB_Device_ConfigurationChanged\r\n");

	bool ConfigSuccess = true;

	/* Setup HID Report Endpoints */
	ConfigSuccess &= Endpoint_ConfigureEndpoint(GENERIC_IN_EPNUM, EP_TYPE_INTERRUPT, GENERIC_REPORT_SIZE, 1);
	ConfigSuccess &= Endpoint_ConfigureEndpoint(GENERIC_OUT_EPNUM, EP_TYPE_INTERRUPT, GENERIC_REPORT_SIZE, 1);
...
{
	printf("ProcessGenericHIDReport\r\n");
